...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn("data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 bg-black/70 duration-100 data-ending-style:opacity-0 data-starting-style:opacity-0 fixed inset-0 z-50", className)}
      {...props}
    />
  )
}
